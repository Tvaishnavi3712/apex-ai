...
@apex_action(ApexActionSchema(
    ...
    input_schema=ActionInputSchema(description="Document classification parameters")
        .add_string("document_s3_uri", "S3 URI of the document to classify (s3://bucket/key)", required=True)
        .add_array(
...
def document_classify(
    ...
    Args:
        document_s3_uri: S3 URI of the document (s3://bucket/key)
    ...
    try:
        ...
        blueprints = _get_available_blueprints(dynamodb, candidate_blueprints, industry_hint)
...
def _get_available_blueprints(
    ...
    """Get available blueprints from DynamoDB"""
