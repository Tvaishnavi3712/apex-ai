...
## Subcloud software not deployed on this host yet
...
(atlas) szabota@welktxefnce-h-pe1util-vm05:~/playbooks/bmc-sapphire-rapids/bmc$ ansible-playbook --vault-password-file /tmp/password -i inventory/welktxsr-931883-rh-le093s6-008.yaml bmc.yaml

PLAY [BMC configuration playbook] *************************************************************************************************************************************************

TASK [Initialize me environment variable] *****************************************************************************************************************************************
skipping: [welktxsr-931883-rh-le093s6-008]

TASK [Initialize prod environment variable] ***************************************************************************************************************************************
ok: [welktxsr-931883-rh-le093s6-008]
...
ok: [welktxsr-931883-rh-le093s6-008 -> localhost]
...
changed: [welktxsr-931883-rh-le093s6-008 -> localhost] => (item=find_ilo_mac_address.py)
changed: [welktxsr-931883-rh-le093s6-008 -> localhost] => (item=ls3_92s3_find_ilo_mac_address.py)
changed: [welktxsr-931883-rh-le093s6-008 -> localhost] => (item=ls6_find_ilo_mac_address.py)
changed: [welktxsr-931883-rh-le093s6-008 -> localhost] => (item=930t_find_ilo_mac_address.py)
...
ok: [welktxsr-931883-rh-le093s6-008] => {
    "msg": "mac address:F0:B2:B9:14:3A:A8 firmware:4.22 (0x8001A52F)"
}
...
included: /home/szabota/playbooks/bmc-sapphire-rapids/bmc/roles/hpe/bios-config/tasks/e930t.yaml for welktxsr-931883-rh-le093s6-008
...
changed: [welktxsr-931883-rh-le093s6-008 -> localhost] => (item=enable_secure_boot.py)
changed: [welktxsr-931883-rh-le093s6-008 -> localhost] => (item=disable_dhcp.py)
changed: [welktxsr-931883-rh-le093s6-008 -> localhost] => (item=configure_dns.py)
changed: [welktxsr-931883-rh-le093s6-008 -> localhost] => (item=configure_syslog.py)
changed: [welktxsr-931883-rh-le093s6-008 -> localhost] => (item=disable_dhcp_ntp.py)
changed: [welktxsr-931883-rh-le093s6-008 -> localhost] => (item=set_ilo_sntp_servers.py)
...
FAILED - RETRYING: [welktxsr-931883-rh-le093s6-008 -> localhost]: Check redfish health after ILO reset (6 retries left).
ok: [welktxsr-931883-rh-le093s6-008 -> localhost]
...
TASK [hpe/system-on : Wait for system to complete POST after power on] ************************************************************************************************************
FAILED - RETRYING: [welktxsr-931883-rh-le093s6-008 -> localhost]: Wait for system to complete POST after power on (50 retries left).
FAILED - RETRYING: [welktxsr-931883-rh-le093s6-008 -> localhost]: Wait for system to complete POST after power on (49 retries left).
FAILED - RETRYING: [welktxsr-931883-rh-le093s6-008 -> localhost]: Wait for system to complete POST after power on (48 retries left).
FAILED - RETRYING: [welktxsr-931883-rh-le093s6-008 -> localhost]: Wait for system to complete POST after power on (47 retries left).
FAILED - RETRYING: [welktxsr-931883-rh-le093s6-008 -> localhost]: Wait for system to complete POST after power on (46 retries left).
FAILED - RETRYING: [welktxsr-931883-rh-le093s6-008 -> localhost]: Wait for system to complete POST after power on (45 retries left).
FAILED - RETRYING: [welktxsr-931883-rh-le093s6-008 -> localhost]: Wait for system to complete POST after power on (44 retries left).
ok: [welktxsr-931883-rh-le093s6-008 -> localhost]
...
FAILED - RETRYING: [welktxsr-931883-rh-le093s6-008 -> localhost]: Wait for system to complete POST after power on (45 retries left).
FAILED - RETRYING: [welktxsr-931883-rh-le093s6-008 -> localhost]: Wait for system to complete POST after power on (44 retries left).
FAILED - RETRYING: [welktxsr-931883-rh-le093s6-008 -> localhost]: Wait for system to complete POST after power on (43 retries left).
FAILED - RETRYING: [welktxsr-931883-rh-le093s6-008 -> localhost]: Wait for system to complete POST after power on (42 retries left).
FAILED - RETRYING: [welktxsr-931883-rh-le093s6-008 -> localhost]: Wait for system to complete POST after power on (41 retries left).
FAILED - RETRYING: [welktxsr-931883-rh-le093s6-008 -> localhost]: Wait for system to complete POST after power on (40 retries left).
FAILED - RETRYING: [welktxsr-931883-rh-le093s6-008 -> localhost]: Wait for system to complete POST after power on (39 retries left).
FAILED - RETRYING: [welktxsr-931883-rh-le093s6-008 -> localhost]: Wait for system to complete POST after power on (38 retries left).
FAILED - RETRYING: [welktxsr-931883-rh-le093s6-008 -> localhost]: Wait for system to complete POST after power on (37 retries left).
FAILED - RETRYING: [welktxsr-931883-rh-le093s6-008 -> localhost]: Wait for system to complete POST after power on (36 retries left).
ok: [welktxsr-931883-rh-le093s6-008 -> localhost]
...
PLAY RECAP ************************************************************************************************************************************************************************
welktxsr-931883-rh-le093s6-008 : ok=60   changed=19   unreachable=0    failed=0    skipped=38   rescued=0    ignored=0
