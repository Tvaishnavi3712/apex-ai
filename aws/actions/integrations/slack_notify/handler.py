...
def lambda_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    """
    AWS Lambda handler for Slack webhook events.
...
def process_approval(
    ...
    # This would call the APEX API or directly update DynamoDB

    dynamodb = boto3.resource("dynamodb")
    table = dynamodb.Table(os.environ.get("WORK_ITEMS_TABLE", "apex-work-items"))
