...
type SampleKey =
  ...
  // STP playbook + its specialist Foundry Agent Service runtime. Filename-based auto-
...
const SAMPLES: Record<SampleKey, Sample> = {
  ...
  port_strike: {
    ...
    fields: [
      ...
      { name: 'BOM Nodes Traversed',value: '847 (via Azure Synapse, 2.1s)',     conf: 99 },
    ...
    flags: [
      ...
      { color: 'green', text: 'BOM graph traversal completed in 2.1s via Azure Synapse' },
    ],
  ...
  boler_cigna_medical: {
    ...
    subLabels: ['Doc ingested', 'Fields extracted', 'Decision logged', 'Indexed to Cosmos DB audit log', `Done in 4.2s`],
    fields: [
  ...
  boler_delta_dental: {
    ...
    subLabels: ['Doc ingested', 'Fields extracted', 'Decision logged', 'Indexed to Cosmos DB audit log', `Done in 3.4s`],
    fields: [
  ...
  boler_fidelity_401k: {
    ...
    subLabels: ['Doc ingested', 'Fields extracted', 'Decision logged', 'Indexed to Cosmos DB audit log', `Done in 3.8s`],
    fields: [
  ...
  boler_vsp_vision: {
    ...
    subLabels: ['Doc ingested', 'Fields extracted', 'Decision logged', 'Indexed to Cosmos DB audit log', `Done in 2.9s`],
    fields: [
  ...
  boler_hartford_life: {
    ...
    subLabels: ['Doc ingested', 'Fields extracted', 'Decision logged', 'Indexed to Cosmos DB audit log', `Done in 3.1s`],
    fields: [
  ...
  boler_cigna_std_ltd: {
    ...
    subLabels: ['Doc ingested', 'Fields extracted', 'Decision logged', 'Indexed to Cosmos DB audit log', `Done in 3.0s`],
    fields: [
  ...
  boler_exc_chen: {
    ...
    subLabels: ['Doc ingested', 'Fields extracted', 'Decision logged', 'Indexed to Cosmos DB audit log', `Done in 4.7s`],
    fields: [
  ...
  boler_exc_martinez: {
    ...
    subLabels: ['Doc ingested', 'Fields extracted', 'Decision logged', 'Indexed to Cosmos DB audit log', `Done in 4.4s`],
    fields: [
  ...
  boler_exc_cigna_drift: {
    ...
    subLabels: ['Doc ingested', 'Fields extracted', 'Decision logged', 'Indexed to Cosmos DB audit log', `Done in 3.7s`],
    fields: [
  ...
  boler_exc_transfers: {
    ...
    subLabels: ['Doc ingested', 'Fields extracted', 'Decision logged', 'Indexed to Cosmos DB audit log', `Done in 2.8s`],
    fields: [
    ...
    routing: "→ Benefits Allocation Agent · auto-fixed · Cosmos DB logged · no HITL required",
  },
  ...
  boler_exc_401k: {
    ...
    subLabels: ['Doc ingested', 'Fields extracted', 'Decision logged', 'Indexed to Cosmos DB audit log', `Done in 4.1s`],
    fields: [
  ...
  boler_exc_thompson: {
    ...
    subLabels: ['Doc ingested', 'Fields extracted', 'Decision logged', 'Indexed to Cosmos DB audit log', `Done in 2.4s`],
    fields: [
    ...
    routing: "→ Benefits Allocation Agent · auto-fixed · Cosmos DB logged",
  },
  ...
  boler_xlsx_consolidated_je: {
    ...
    flags: [
      ...
      { color: "green", text: "Two-stage approval complete · audit chain hash-linked in Cosmos DB" },
...
Storage: Cosmos DB · partition=2026-06 · sort=EXC-0441
...
Storage: Cosmos DB · partition=2026-06 · sort=EXC-0442
...
Storage: Cosmos DB · partition=2026-06 · sort=EXC-0443
...
─────────────── ROUTING ───────────────
  ...
  • Approval log:      Logged to Cosmos DB (no human approval needed per policy)
  • Notification:     Confirmation email to Sarah Mitchell + audit log

Storage: Cosmos DB · partition=2026-06 · sort=EXC-0444
...
Storage: Cosmos DB · partition=2026-06 · sort=EXC-0445
...
Storage: Cosmos DB · partition=2026-06 · sort=EXC-0446
...
Storage: Cosmos DB · partition=2026-06 · sort=EXC-0447
...
Storage: Cosmos DB · partition=2026-06 · sort=JE-HEND-006
...
const AGENT_HUB_LINK: Record<SampleKey, string> = {
  ...
  // STP Phase 2 — route each sample to its dedicated Foundry Agent Service runtime via
