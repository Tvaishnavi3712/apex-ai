...
1. **AgentCore runtime** — invokes the specialist's runtime ARN via
   `bedrock-agentcore.invoke_agent_runtime`. Configure ARNs via:
   - `APEX_STP_POLICY_ARN`
...
```bash
cd agentcore-agents/apex-stp-chatstp-router
