...
This agent runs on Azure AI Foundry Agent Service. The deploy script
...
# Foundry Agent Service extracts the deploy ZIP and runs agent.py from that directory,
