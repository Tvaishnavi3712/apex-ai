...
interface Connector {
  ...
  config?: {
    endpoint: string;
    authType: 'Entra ID Managed Identity' | 'OAuth 2.0' | 'API Key' | 'Service Principal' | 'Mutual TLS';
...
const SECTIONS: Section[] = [
    ...
    connectors: [
      {
        ...
        config: {
          ...
          authType: 'Entra ID Managed Identity',
  ...
  },
  {
    ...
    connectors: [
      { code: 'BDA', name: 'Azure AI Document Intelligence', subtitle: 'Document extraction AI', status: 'connected', iconBg: '#fff7ed', iconColor: '#ea580c' },
      { code: 'BA',  name: 'Foundry Agents',          subtitle: 'AI agent runtime',       status: 'connected', iconBg: '#f0fdf4', iconColor: '#16a34a' },
      { code: 'S3',  name: 'Azure Blob Storage',               subtitle: 'Document storage',       status: 'connected', iconBg: '#eff6ff', iconColor: '#2563eb' },
      { code: 'DDB', name: 'Cosmos DB',                subtitle: 'Work item store',        status: 'connected', iconBg: '#f5f3ff', iconColor: '#7c3aed' },
    ],
  },
  {
...
const CATALOG_SECTIONS: Section[] = (() => {
  ...
  const order = [
    ...
    'Azure Services', 'Azure Services', 'GCP Services', 'AI / ML Services',
  ];
  return order
