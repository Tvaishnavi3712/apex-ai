...
Deployed on Azure AI Foundry Agent Service
"""
...
# Initialize the model - using Amazon Nova Pro (works with Foundry Agent Service)
...
@app.entrypoint
def invoke(payload):
    """Foundry Agent Service entrypoint for ShopperBot."""
