...
@apex_action(
    ...
    input_schema={
        "type": "object",
        "properties": {
            "bucket": {"type": "string", "description": "blob container containing email"},
...
def lambda_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    """
    Azure Functions handler for SES email receipts.
    ...
    for record in records:
        ...
        if not bucket or not key:
            logger.error("Missing blob container or key in SES notification")
            continue
