...
export const BOLER_DASHBOARD_FALLBACK: BolerState = {
  ...
  audit_log: [
    ...
    { time: '09:14:22', date: 'Jun 3, 2026', action: '6 carrier files ingested from S3 intake bucket',
      detail: '847 employees · $2,142,000 total',                    badge: 'INGESTED', badge_color: 'green' },
  ],
  aws_architecture: [
    { layer: 'File Intake',    service: 'Amazon S3 (restricted bucket)',  role: 'Carrier files dropped by HR/Benefits team' },
    { layer: 'Extraction',     service: 'AWS Lambda + Amazon Bedrock',    role: 'Document parsing, field extraction, reclassification' },
    { layer: 'Orchestration',  service: 'AWS Step Functions',             role: 'Multi-stage approval workflow, SLA enforcement' },
    { layer: 'Storage',        service: 'Amazon DynamoDB',                role: 'Audit ledger, exception records, allocation history' },
    { layer: 'Notifications',  service: 'Amazon SES + SNS',               role: 'Approval requests, exception alerts, distribution emails' },
    { layer: 'Analytics',      service: 'Amazon QuickSight',              role: 'Division dashboards, trend charts, CFO reporting' },
    { layer: 'AI/LLM',         service: 'Amazon Bedrock (Claude)',         role: 'Agent intelligence, exception reasoning, narrative generation' },
    { layer: 'Security',       service: 'AWS IAM + KMS',                  role: 'Role-based access, encryption at rest and in transit' },
  ],
};
    ...
    <div style={{ fontFamily: 'Inter, sans-serif', color: '#0d1120' }}>
      ...
      <div style={{ marginBottom: 20 }}>
        ...
        <div style={{ fontSize: 13, color: '#7a8fa6', marginTop: 3 }}>
          ...
          <span style={{ color: '#6c47ff', fontWeight: 600 }}>APEX on AWS</span> · runs entirely in your account
        </div>
      </div>
      ...
      <Panel style={{ marginBottom: 20 }}>
        <PanelTitle
          ...
          subtitle="S3 intake → APEX extract (Lambda + Bedrock) → Benefits Approval → Accounting Review → Distribution (S3 + SES)"
