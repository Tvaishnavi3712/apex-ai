...
const NODES: NodeDef[] = [
  ...
  { id: 'n3', kind: 'enrich',   title: 'Vendor Lookup',     sub: 'DynamoDB · vendors',      x: 590, y: 120, icon: UserCircleIcon,            status: 'ok',      conf: 0.99 },
      ...
      <div className="flex-1 flex min-h-0">
        ...
        >
          ...
          <div className="p-5 space-y-5">
            ...
            <Field label="Runtime" value="AgentCore · Strands" />
