  ...
  return (
    <>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 14, marginBottom: 24 }}>
        ...
        <Kpi label="Avg Response"          value={`${avgLatencyS.toFixed(1)}s`}      delta="p95 26.9s · live AgentCore"        tone={SLATE} />
...
function ComplianceScorecard({
  ...
  const rows = [
    { label: '10 CFR 50.71 · Records retention',  value: '100%', tone: GREEN, note: '7-year audit-log persistence in DynamoDB' },
