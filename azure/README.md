...
│   ├── services/          # Cosmos DB, S3, Action Registry
│   ├── core/              # Configuration
│   └── main.py
│
...
│   ├── sdk/               # Apex Action SDK
│   ├── core/              # Core actions (BDA, Cosmos DB, S3)
...
- **Apex Agent Runtime**: Azure OpenAI Foundry Agent Service for AI-native orchestration
- **Apex Document Engine**: Azure AI Document Intelligence for document processing
- **Apex Actions**: Foundry Agent Service Gateway for tool integration
...
| Agent Runtime | Azure OpenAI Foundry Agent Service |
| Document Processing | Azure AI Document Intelligence |
| Actions/Tools | Foundry Agent Service Gateway + Lambda |
| Database | Cosmos DB |
| Storage | S3 |
