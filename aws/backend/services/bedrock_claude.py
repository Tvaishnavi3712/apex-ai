...
class BedrockClaudeService:
    ...
    MODELS = {
        ...
        "claude-4-opus": "us.anthropic.claude-opus-4-6-v1",
        # Aliases
        "opus-4-6": "us.anthropic.claude-opus-4-6-v1",
    }

    # GovCloud models (same IDs work in us-gov-west-1)
    GOVCLOUD_MODELS = {
        "claude-opus-4-6": "us.anthropic.claude-opus-4-6-v1",
        "claude-3-sonnet": "anthropic.claude-3-sonnet-20240229-v1:0",
        "claude-3-haiku": "anthropic.claude-3-haiku-20240307-v1:0",
    ...
    # Default model for aerospace/defense (highest capability)
    AEROSPACE_MODEL = "claude-opus-4-6"
