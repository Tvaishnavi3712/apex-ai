#!/usr/bin/env python3
"""
Verizon Far Edge — generate training data for the 3 Azure ML endpoints:
...
Outputs (written here, then uploaded by deploy_azure_ml_vz_endpoints.py):
...
# Canonical enums shared with backend/services/azure_ml.py
...
def build_thermal_telemetry() -> Path:
    ...
    Output format: Azure ML RCF wants a CSV (no header) with all numeric
...
def main():
    ...
    print("  python3 backend/scripts/deploy_azure_ml_vz_endpoints.py")
