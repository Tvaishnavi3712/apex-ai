  ...
  return (
    <div>
      ...
      <div style={{
        ...
        Decision will be hash-chained into DynamoDB audit log · IAM role: BenefitsHITLApprover
      </div>
    </div>
  );
}
  ...
  return (
    <div>
      ...
      <div style={{
        ...
        Sign-off triggers AWS Step Functions distribution to 5 division S3 inboxes (KMS per-division keys) + SES notification to division controllers · ~18s end-to-end
      </div>
    </div>
  );
}
