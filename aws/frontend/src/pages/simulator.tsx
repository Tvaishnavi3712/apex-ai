 ...
 *                                             Logistics AgentCore runtime and
...
interface RunResponse {
  scenario_id:   string;
  status:        'complete' | 'agentcore_offline';
...
function GenericSimulatorPage() {
  ...
  const runSim = async () => {
    ...
    try {
      ...
      // AgentCore call. If latency_ms is large, we cap the reveal at ~6s total.
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12, flexWrap: 'wrap' }}>
          <div>
            ...
            <div style={{ fontSize: 12, color: '#cbd5e1', marginTop: 4 }}>
              Agentic war-gaming for the C-suite — dispatches to the Logistics AgentCore runtime and streams its real reasoning trace back.
            </div>
          </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '300px 1fr 360px', gap: 16 }}>
        ...
        <section style={{
          ...
          <div style={{ fontSize: 12, color: '#94a3b8', marginBottom: 14 }}>
            {scenariosQ.isLoading ? 'Loading scenarios…' : `${scenarios.length} scenario${scenarios.length === 1 ? '' : 's'} · persisted in DynamoDB`}
          </div>
            ...
            <div>
              ...
              {runState.kind === 'done' && (
                <div style={{ fontSize: 11, color: '#cbd5e1', marginTop: 4 }}>
                  AgentCore · {runLatency} ms · {runStatus === 'agentcore_offline' ? 'offline (returned fallback)' : 'complete'}
                </div>
              )}
            </div>
          ...
          <div style={{
            ...
            {runState.kind === 'idle' && (
              <div style={{ color: '#94a3b8' }}>
                <div>&gt; standing by · click <span style={{ color: '#a78bfa', fontWeight: 600 }}>▶ Run Simulation</span> to dispatch this scenario to the Logistics AgentCore runtime.</div>
    ...
    >
      ...
      >
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 14, gap: 10 }}>
          <div>
            ...
            <div style={{ fontSize: 12, color: '#94a3b8', marginTop: 2 }}>
              Persisted to DynamoDB. Re-runnable by anyone on this environment. Seeded demos are protected.
            </div>
          </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 14 }}>
          ...
          <DarkField label="Agent (routes to AgentCore)">
