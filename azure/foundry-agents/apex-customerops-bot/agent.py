"""
Apex CustomerOps Agent — Foundry Agent Service runtime for CBB Demo 1 (Zero-Touch Order
Modification).
...
- Data lake: Azure Blob Storage + Athena federated queries against cbb_orders table
...
# Lazy-init: Foundry Agent Service enforces a 30s cold-start budget for the runtime to
# start serving HTTP traffic. Heavy strands-agents/Azure OpenAI init at module
