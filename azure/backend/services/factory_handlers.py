...
def register_all_handlers():
    ...
    # Aerospace & Defense handlers (Essex Industries Demo)
    aerospace_defense_handlers = [
        ("actions.aerospace_defense.contract_lookup.handler", "contract_lookup"),
        ("actions.aerospace_defense.erp_write.handler", "erp_write"),
        ("actions.aerospace_defense.erp_write.handler", "quality_ncr_create"),
        ("actions.aerospace_defense.cnc_code_review.handler", "cnc_code_review"),
        ("actions.aerospace_defense.design_assistant.handler", "design_assistant"),
    ]
