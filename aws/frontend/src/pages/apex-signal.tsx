 ...
 *   • Risk Radar       — GET /signals/risks (DynamoDB predictive_events + SageMaker lead-time refresh)
 *   • Demand Sensing   — GET /signals/demand (SageMaker DeepAR)
 *   • Stockout Forecast— GET /signals/stockout (SageMaker Linear Learner per inventory row)
 *   • Supplier Health  — GET /signals/suppliers (SageMaker XGBoost multi-class)
 *
 * "View Playbook →" on a risk card → POST /signals/risks/{id}/playbook which
 * invokes the real Logistics AgentCore runtime (same pattern as Simulator).
 */
...
function GenericApexSignal() {
  ...
  const tagline = isSTP
    ...
    : 'SageMaker forecasts + Bedrock AgentCore mitigation. Agents see the storm before it hits.';
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 14, gap: 10 }}>
          <div>
            ...
            <div style={{ fontSize: 12, color: '#94a3b8', marginTop: 2 }}>
              Logistics AgentCore runtime · Claude Opus 4.6 via Bedrock AgentCore
            </div>
          </div>
        ...
        {mutation.isPending && (
          <div style={{ padding: 30, textAlign: 'center', color: '#94a3b8' }}>
            <div style={{ fontFamily: "'JetBrains Mono', ui-monospace, monospace", fontSize: 13 }}>
              Dispatching to Logistics AgentCore…
            </div>
 ...
 * synthetic-data corpus the STP action handlers + AgentCore agents use.
 * Once the live SageMaker endpoints (apex-signal-stp-rul / -anomaly /
