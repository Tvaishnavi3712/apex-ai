...
const STAGES: Stage[] = [
  ...
  { kind: 'extract',   title: 'BDA extracts the report', detail: 'Bedrock Data Automation parses frontmatter + per-MEAKV results into structured fields.', mono: 'platform=HPE EL140 Gen12 · iLO7 1.20.00 · 32 MEAKV rows', dur: 1600 },
...
const SOURCES = {
  s3:  { label: 'Amazon S3',            short: 'S3',  event: 'S3 ObjectCreated event',      path: 's3://apex-far-edge-incoming/EL140/test-campaign-EL140-Gen12.md' },
