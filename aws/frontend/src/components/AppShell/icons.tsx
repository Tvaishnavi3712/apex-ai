/**
 * Apex icons — ported from apex-prototype 2/*.html (ICONS map).
 * A small in-house icon set so we don't depend on Heroicons for the shell.
 */

import React from 'react';

export type IconName =
  | 'home' | 'doc' | 'pipeline' | 'bolt' | 'inbox' | 'tray' | 'mic' | 'check'
  | 'chart' | 'cpu' | 'db' | 'flask' | 'gear' | 'plus' | 'arrow_right'
  | 'arrow_left' | 'x' | 'check_circle' | 'upload' | 'search' | 'bell'
  | 'send' | 'eye' | 'play' | 'stop' | 'cloud_up' | 'sparkle' | 'warning'
  | 'chevron_left' | 'chevron_right' | 'menu' | 'pencil' | 'trash'
  | 'copy' | 'download' | 'refresh' | 'filter' | 'phone' | 'info'
  | 'lock' | 'users' | 'globe' | 'code';
...
const PATHS: Record<IconName, React.ReactNode> = {
  ...
  pipeline:      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/>,
  ...
  tray:          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4"/>,
  ...
  cpu:           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 3H5a2 2 0 00-2 2v4m6-6h10a2 2 0 012 2v4M9 3v18m0 0h10a2 2 0 002-2V9M9 21H5a2 2 0 01-2-2V9m0 0h18"/>,
  db:            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4"/>,
  ...
  chevron_left:  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7"/>,
  chevron_right: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7"/>,
  ...
  play:          <><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z"/><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></>,
  stop:          <><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 10h6v4H9z"/></>,
  cloud_up:      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"/>,
...
export function Icon({ name, className = 'w-5 h-5', style }: { name: IconName; className?: string; style?: React.CSSProperties }) {
  return (
