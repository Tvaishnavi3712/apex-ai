 ...
 *
 * Wired to 3 SageMaker endpoints via /api/v1/signals/vz/*:
    ...
    <div style={{ background: '#f8fafc', minHeight: '100vh', padding: '28px 32px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 24 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          <span style={chip(
            ...
            {modelsLive ? '3 SageMaker Models Live' : 'Models Degraded'}
          </span>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{ position: 'relative' }}>
          ...
          <p style={{ fontSize: 13, color: '#94a3b8', maxWidth: 720, lineHeight: 1.6, marginBottom: 18 }}>
            Apex Signal scores every site in the deployment wave by risk using three SageMaker models —
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1.6fr 1fr', gap: 20, marginBottom: 20 }}>
        ...
        <div style={{ ...card, padding: 22 }}>
          ...
          {/* Wave score banner — driven by SageMaker prediction */}
          {waveQuery.data && (
            <div style={{
