#!/usr/bin/env python3
"""
EPROD — generate training data for the 3 SageMaker endpoints:
...
Outputs (written here, then uploaded by deploy_sagemaker_eprod_endpoints.py):
...
All CSVs are headerless, label-first column (SageMaker XGBoost convention).
...
def main():
    ...
    print("  python3 backend/scripts/deploy_sagemaker_eprod_endpoints.py")
