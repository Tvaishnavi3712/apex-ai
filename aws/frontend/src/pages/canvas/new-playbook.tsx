...
- Receive document from S3 trigger or API upload
...
- Log all decisions to DynamoDB audit trail`}
            />
          </div>
...
const GALLERY = [
  ...
  { name: 'core.write_dynamodb',        desc: 'Persist extracted data to DynamoDB',        tag: 'store',    tagLabel: 'Store' },
  { name: 'core.email_notify',          desc: 'Send email notification via SES',           tag: 'notify',   tagLabel: 'Notify' },
  { name: 'core.invoke_lambda',         desc: 'Invoke custom AWS Lambda function',         tag: 'execute',  tagLabel: 'Execute' },
