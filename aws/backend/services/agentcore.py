...
class AgentCoreService:
    ...
    # Deployed agent ARNs
    AGENT_ARNS = {
        # Verizon Far Edge agents — deployed via agentcore-agents/deploy_verizon_agents.py
        # (S3 zip → AgentCore runtime, no Docker). All READY 2026-06. The demo invokes the
        # in-process simulator for zero cold-start; these ARNs make the deployed runtimes
        # discoverable + invocable end-to-end.
        "verizon-orchestrator-agent": "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_verizon_orchestrator-fxBITV24q5",
        "certification-agent":  "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_verizon_certification-BAuVJw5Okv",
        "schemawatch-agent":    "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_verizon_schemawatch-NIltb2GI9m",
        "upgrade-advisor-agent":"arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_verizon_upgradeadvisor-l786yy5DkF",
        "mentor-agent":         "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_verizon_mentor-Pjl0t5BnJp",
        "playbook-agent":       "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_verizon_playbook-TFE2HDHTW4",
        ...
        "contract-bot": "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_contract_bot",
        "cnc-bot": "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_cnc_bot",
        "workorder-bot": "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_workorder_bot",
        # CBB demo agents — deployed via agentcore-agents/deploy_cbb_agents.py
        "customerops-bot": "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_customerops_bot-NC2S8Z5SZF",
        "customerops":     "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_customerops_bot-NC2S8Z5SZF",
        "qc-bot":          "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_qc_bot-01U6KHAeej",
        "qcbot":           "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_qc_bot-01U6KHAeej",
        "logistics-bot":   "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_logistics_bot-VmOgazE4LN",
        "logisticsbot":    "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_logistics_bot-VmOgazE4LN",
        # STP Phase 2 agents — DEPLOYED 2026-04-30 via agentcore-agents/deploy_stp_agents.py
        # All five runtimes are status=READY in us-east-1. Replacing PLACEHOLDER
        # turns off the in-process composer fallback for these ids and routes
        # invocations through the real Bedrock AgentCore runtime via AWS CLI.
        "chatstp":              "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_stp_chatstp_router-JxzvXpBkNX",
        "chatstp-router":       "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_stp_chatstp_router-JxzvXpBkNX",
        "stp-router":           "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_stp_chatstp_router-JxzvXpBkNX",
        "policy-agent":         "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_stp_policy_agent-9pZgSy5aWz",
        "policyagent":          "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_stp_policy_agent-9pZgSy5aWz",
        "stp-policy":           "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_stp_policy_agent-9pZgSy5aWz",
        "maintenance-agent":    "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_stp_maintenance_agent-JQoz4G5QqB",
        "maintenanceagent":     "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_stp_maintenance_agent-JQoz4G5QqB",
        "stp-maintenance":      "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_stp_maintenance_agent-JQoz4G5QqB",
        "diagnostics-agent":    "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_stp_diagnostics_agent-s3l3Wc9HUp",
        "diagnosticsagent":     "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_stp_diagnostics_agent-s3l3Wc9HUp",
        "stp-diagnostics":      "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_stp_diagnostics_agent-s3l3Wc9HUp",
        "reliability-agent":    "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_stp_reliability_agent-oVMXghD955",
        "reliabilityagent":     "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_stp_reliability_agent-oVMXghD955",
        "stp-reliability":      "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_stp_reliability_agent-oVMXghD955",
        # Agentic Enterprise (66 Degrees vendor-neutral demos) — DEPLOYED
        # 2026-05-04 via agentcore-agents/deploy_ae_agents.py. All three
        # runtimes are status=READY in us-east-1. Each one bundles its own
        # synthetic-data files (no hardcoded business data — see agent.py
        # data-loading helpers).
        "orchestrator-agent":   "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_ae_orchestrator_agent-2XBQK2Hx2u",
        "orchestratoragent":    "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_ae_orchestrator_agent-2XBQK2Hx2u",
        "supply-orchestrator":  "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_ae_orchestrator_agent-2XBQK2Hx2u",
        "concierge-agent":      "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_ae_concierge_agent-2L9Ce23aYW",
        "conciergeagent":       "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_ae_concierge_agent-2L9Ce23aYW",
        "cruise-concierge":     "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_ae_concierge_agent-2L9Ce23aYW",
        "lease-agent":          "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_ae_lease_agent-fJthevCl78",
        "leaseagent":           "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_ae_lease_agent-fJthevCl78",
        "lease":                "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_ae_lease_agent-fJthevCl78",
        # ─── EPROD (Enterprise Products Partners) — DEPLOYED 2026-05-27 via
        # agentcore-agents/deploy_eprod_agentcore.py. 6 runtimes, all READY.
        # Frontend uses `eprod-<role>-agent` id pattern; we register every
        # spelling variant (slug + compact + customer-prefixed) so the
        # chat router resolves them through AGENT_ARNS.get() lookups.
        "eprod-invoice-agent":  "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_eprod_invoice_bot-7Jg1h9BzyU",
        "eprodinvoiceagent":    "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_eprod_invoice_bot-7Jg1h9BzyU",
        "apex_eprod_invoice_bot":"arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_eprod_invoice_bot-7Jg1h9BzyU",
        "eprod-po-agent":       "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_eprod_po_bot-hn4Owc7JB3",
        "eprodpoagent":         "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_eprod_po_bot-hn4Owc7JB3",
        "apex_eprod_po_bot":    "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_eprod_po_bot-hn4Owc7JB3",
        "eprod-vendor-agent":   "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_eprod_vendor_bot-woE0s1FGwP",
        "eprodvendoragent":     "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_eprod_vendor_bot-woE0s1FGwP",
        "apex_eprod_vendor_bot":"arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_eprod_vendor_bot-woE0s1FGwP",
        "eprod-quote-agent":    "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_eprod_quote_bot-lOQbkMGN2D",
        "eprodquoteagent":      "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_eprod_quote_bot-lOQbkMGN2D",
        "apex_eprod_quote_bot": "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_eprod_quote_bot-lOQbkMGN2D",
        "eprod-tariff-agent":   "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_eprod_tariff_bot-bua6Vp3Xt0",
        "eprodtariffagent":     "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_eprod_tariff_bot-bua6Vp3Xt0",
        "apex_eprod_tariff_bot":"arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_eprod_tariff_bot-bua6Vp3Xt0",
        "eprod-jib-agent":      "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_eprod_jib_bot-bnfeF2C6IL",
        "eprodjibagent":        "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_eprod_jib_bot-bnfeF2C6IL",
        "apex_eprod_jib_bot":   "arn:aws:bedrock-agentcore:us-east-1:457795063704:runtime/apex_eprod_jib_bot-bnfeF2C6IL",
    }

    # EPROD agent keys — hard-route to AgentCore runtimes (deployed). Keeps
    ...
    # agents work OFFLINE (no AgentCore round-trip) anchored on the REAL
    ...
    # CBB demo agent keys — must route to their own AgentCore runtime, NOT the
    ...
    # (or to AgentCore runtimes once deploy_stp_agents.py has run). Like the
    ...
    # No AgentCore deploy required — the demo runs offline.
    ...
    async def invoke_agent(
        ...
        Routing priority:
          1. CBB agents (customerops, qcbot, logisticsbot) — always go to their
             own deployed AgentCore runtimes. Skip the aerospace keyword matcher
        ...
        Args:
            ...
            session_id: APEX chat session id. Forwarded to AgentCore as the
        ...
        # runtime-session-id is ALSO passed through for AgentCore-native
        ...
        #    (or to AgentCore runtimes once deploy_stp_agents.py has run and
        ...
        # 0a-EPROD. EPROD agents — hard-route to AgentCore runtimes.
        # The 6 EPROD agents are READY in us-east-1 (deployed 2026-05-27 via
        # deploy_eprod_agentcore.py). Without this hard-route, ids like
        ...
        if _matches(self.EPROD_AGENT_IDS):
            # Skip AgentCore — the 6 EPROD runtimes are deployed but their
            ...
            # sub-50ms deterministic responses. AgentCore stays deployed
            # (we're paying for it); flip the conditional below to re-enable
            # the live runtimes once the cold-start is debugged separately.
            #
            #   ENABLE_EPROD_AGENTCORE = False   <-- flip to True to re-test
            ENABLE_EPROD_AGENTCORE = False
            if ENABLE_EPROD_AGENTCORE:
                eprod_arn = (
                ...
                if eprod_arn:
                    try:
                        result = await self._invoke_via_aws_cli(
                            eprod_arn, multi_turn_prompt, session_id=session_id
                        )
                        if result.get("success"):
                            return result
                    except Exception as e:
                        print(f"[eprod-router] AgentCore exception for {agent_id}: {e}")
        ...
        # Vendor & Contract, Policy & HR) are NOT deployed to AgentCore for
        # round 1 of this customer demo (per the user's "skip SageMaker /
        # AgentCore for now" directive). Simulator returns sub-50ms,
        ...
        # across 5 divisions / 847 employees. Same skip-AgentCore-for-now
        # directive as CWFCU.
        ...
        # UpgradeAdvisor, Mentor) work offline with zero AgentCore dependency.
        ...
        #   1. PRODUCTION — AgentCore runtime ARN registered (not PLACEHOLDER):
        #      delegate to _invoke_via_aws_cli. The deployed Strands agent
        #      reads the same synthetic-data files (bundled into its ZIP).
        #   2. DEMO (offline) — no ARN registered yet, OR the AgentCore call
        #      returns an error: fall through to the in-process simulator in
        #      services/agentic_enterprise_demo.py. Sub-50ms, deterministic.
        #
        # This belt-and-suspenders means the demo is always live: if AgentCore
        ...
        if _matches(self.AGENTIC_ENTERPRISE_AGENT_IDS):
            ...
            if ae_arn and "PLACEHOLDER" not in ae_arn:
                try:
                    ...
                    if result.get("success"):
                        return result
                    # AgentCore returned non-success — log and fall through
                    # to the in-process simulator so the demo never dead-ends.
                except Exception as e:
                    print(f"[ae-router] AgentCore invocation failed for {agent_id}: {e}; "
        ...
        if agent_id in self.CBB_AGENT_IDS:
            ...
            if cbb_arn:
                try:
                    ...
                    if result.get("success"):
                        return result
                    # AgentCore error — surface it, don't pretend everything's fine with CRE text.
                    return {
                        "success": False,
                        "response": self._format_agentcore_error(agent_id, result),
                        "error": result.get("error", "AgentCore invocation failed"),
                        "reasoning": [],
                        "actions_taken": [],
                    }
                except Exception as e:
                    return {
                        "success": False,
                        "response": f"I hit an error reaching the {agent_id} runtime on AgentCore: {e}. Try again in a moment, or check the runtime status in the Bedrock console.",
                        "error": str(e),
                        "reasoning": [],
                        "actions_taken": [],
                    }
        ...
        if agent_arn:
            try:
                result = await self._invoke_via_aws_cli(
                    agent_arn, multi_turn_prompt, session_id=session_id
                )
                if result.get("success"):
                    return result
                return {
                ...
                return {
                    "success": False,
                    "response": f"Error reaching AgentCore runtime for {agent_id}: {e}",
                    "error": str(e),
                    "reasoning": [],
                    "actions_taken": [],
                }
        ...
        return {
            "success": False,
            "response": (
                f"I don't have a deployed AgentCore runtime registered for '{agent_id}'. "
                "Add it to backend/services/agentcore.py::AgentCoreService.AGENT_ARNS "
                "or deploy one via agentcore-agents/deploy_cbb_agents.py."
            ),
    ...
    @staticmethod
    def _format_agentcore_error(agent_id: str, result: Dict[str, Any]) -> str:
        """User-facing error for an AgentCore call that came back with success=False."""
        err = result.get("error", "unknown AgentCore error")
        return (
            f"AgentCore runtime for **{agent_id}** returned an error:\n\n`{err}`\n\n"
            "Check the runtime status in the Bedrock console or re-deploy via "
            "`agentcore-agents/deploy_cbb_agents.py`."
        )
    ...
    #
    # Two-mode invoker:
    #   1. PRODUCTION — AgentCore runtime ARN is registered (no PLACEHOLDER):
    #      delegate to _invoke_via_aws_cli. This is what runs after
    ...
    #      handlers directly. No Bedrock LLM call, no Strands dependency,
    ...
    async def _invoke_stp_agent(
        ...
        """Invoke an STP agent — AgentCore if deployed, in-process composer otherwise.

        `model_overrides` carries per-agent per-slot Bedrock model picks from
        ...
        and switches BedrockModel per task. The in-process composer also
        reads it to annotate the audit log with the chosen model_id.
        """
        norm = agent_id.replace("_", "-").lower()

        # Production path — real AgentCore runtime ARN registered.
        ...
        if arn and "PLACEHOLDER" not in arn:
            return await self._invoke_via_aws_cli(
                arn, prompt,
                session_id=session_id,
    ...
    def _compose_stp_response(
        ...
        def step(idx: int, kind: str, action: str, text: str, output: Any = None,
            ...
            # to "think" if this were the live AgentCore path.
    ...
    def _invoke_eprod_simulator(self, agent_id: str, prompt: str) -> Dict[str, Any]:
        ...
        Triggers when AgentCore cold-start exceeds the 30s ceiling — keeps
        ...
        # ── JIBAgent ⭐ ─────────────────────────────────────────────────
            ...
            response = (
                ...
                "I'm running in simulator-fallback mode (AgentCore cold-start exceeded 30s). "
        ...
        return {
            ...
            "response":  response,
            "reasoning": [
                "Routed via EPROD simulator (AgentCore cold-start fallback)",
    ...
    async def _invoke_via_aws_cli(
        ...
        When session_id is provided, it's forwarded to AgentCore as the
        ...
        AgentCore requires the session id to be ≥33 chars, so we pad
        ...
        their BedrockModel at tool-call vs synthesis time.
        """
        try:
            ...
            # is merged so STP agents can switch BedrockModel per call.
            ...
            # AgentCore rejects session ids shorter than 33 chars. Pad with a
            # deterministic suffix so the same logical session still maps to
            # the same runtime session on the AgentCore side.
    ...
    def _invoke_boler_simulator(self, agent_id: str, prompt: str) -> Dict[str, Any]:
        ...
        if "benefits" in agent_id:
            if "high" in p and "exception" in p:
                response = (
                    ...
                    "[Audit Lens: query logged to DynamoDB] · → Exception Resolution Agent has prepared the reclassification."
                )
        ...
        # ── ExceptionResolutionAgent (EXC) ──────────────────────────────
            ...
            if "exc-2026-0441" in p or "exc-0441" in p or ("chen" in p and ("walk" in p or "exception" in p)):
                ...
                response = (
                    ...
                    "→ All auto-fixes logged to DynamoDB audit ledger with full lineage."
                )
        ...
        # ── JournalEntryAgent (JE) ──────────────────────────────────────
            ...
            if "hendrickson" in p and ("generate" in p or "journal entry" in p):
                ...
                response = (
                    ...
                    "→ All decisions and lineage immutably logged to DynamoDB."
                )
            else:
                response = (
        ...
        # ── AuditLensAgent (AUD) ────────────────────────────────────────
            ...
            if "audit trail" in p or ("full" in p and "trail" in p):
                response = (
                    "Audit Trail · June 2026 Cycle · The Boler Company · DynamoDB\n\n"
                    ...
                    "All entries immutably stored in DynamoDB · KMS encrypted · 100% audit coverage."
                )
                ...
                response = (
                    ...
                    "All ingestion lineage stored in DynamoDB with KMS-encrypted file hashes."
                )
                ...
                response = (
                    ...
                    "Audit ID: AUDIT-2026-06-06-09:41:03-EXC-0441-APPLIED\n"
                    "Storage: DynamoDB (immutable) · KMS-encrypted · S3 backup hourly"
                )
            elif "coverage" in p:
                response = (
                    ...
                    "Storage: Amazon DynamoDB · KMS encrypted · cross-region replication\n"
                ...
                response = (
                    ...
                    "  • DynamoDB lineage graph (PDF visualization)\n"
                ...
                response = (
                    ...
                    "  Ingest:           Jun 3 09:14:22 by Benefits Allocation Agent (Lambda + Bedrock)\n"
                    ...
                    "Storage:           DynamoDB · table=boler_lineage · partition=2026-06 · sort=cigna-medical\n"
                    "Query path:       Single-shot lookup · <50ms"
                )
            else:
                response = (
                    f"{agent_label} (Boler) ready. 100% audit coverage · 15,246 events logged this cycle · "
                    "DynamoDB immutable · KMS-encrypted · SOC 2 audit-ready.\n\n"
    ...
    def get_available_agents(self) -> list:
        ...
        return [
            ...
            # Aerospace & Defense agents (Essex Industries)
            {"id": "contract-bot", "name": "ContractBot", "description": "Defense contract analysis, pricing prediction, RFP support - Claude Opus 4.6", "category": "aerospace_defense"},
            {"id": "cnc-bot", "name": "CNCBot", "description": "CNC programming assistance, G-code review, machining optimization - Claude Opus 4.6", "category": "aerospace_defense"},
            {"id": "workorder-bot", "name": "WorkOrderBot", "description": "Work order management, ERP read/write, NCR creation - Claude Opus 4.6", "category": "aerospace_defense"},
