...
# ZT Proteus BIOS .30
# Redfish Functional Testing MEAKV-648-MEAKV-655 
# 10/16/25 James Patchett


## Target Subcloud  welktxef-931856-rz-le0pts6-004
...
## Subcloud welktxef-931856-rz-le0pts6-004

## MEAKV-648
## Check version of BIOS and BMC
```log
[XXXXXX@welktxme-jump140 ~]$ IP=2607:f160:10:80b1:ce:40a:0:e003
[XXXXXX@welktxme-jump140 ~]$ curl -gsk -u XXXXXX:XXXXXX -X GET https://[${IP}]/redfish/v1/UpdateService/FirmwareInventory/BIOS | jq .
{
  "@odata.context": "/redfish/v1/$metadata#SoftwareInventory.SoftwareInventory",
  "@odata.etag": "\"1755017504\"",
...
[XXXXXX@welktxme-jump140 ~]$ curl -gsk -u XXXXXX:XXXXXX -X GET https://[${IP}]/redfish/v1/UpdateService/FirmwareInventory/BMC | jq .
{
  "@odata.context": "/redfish/v1/$metadata#SoftwareInventory.SoftwareInventory",
...
```log
(ansible_2.10.15) [XXXXXX@welktxefnce-h-pe1util-vm01 vcp-fe-ib-automation]$ ansible-playbook --vault-password-file vault_pass.txt -i inventory/zt-proteus-jamse.yml -e attributes_file=vars/proteus_redfish_attributes.yml -e target="welktxef-931856-rz-le0pts6-004" --tags hostname ZT_Redfish_tests.yml

PLAY [welktxef-931856-rz-le0pts6-004] ***************************************************************************************************************
...
ok: [welktxef-931856-rz-le0pts6-004] => {
    "response": {
        ...
        "cookies": {},
        "cookies_string": "",
        "date": "Wed, 22 Oct 2025 00:36:34 GMT",
        "elapsed": 2,
        "etag": "\"1761093394\"",
        "failed": false,
        ...
        "status": 204,
        "url": "https://[2607:f160:10:80b1:ce:40a:0:e003]/redfish/v1/Systems/Self"
    }
}
...
ok: [welktxef-931856-rz-le0pts6-004 -> localhost]
included: /home/XXXXXX/playbooks/vcp-fe-ib-automation/roles/redfish/attributes/tasks/check_attribute.yml for welktxef-931856-rz-le0pts6-004
...
ok: [welktxef-931856-rz-le0pts6-004] => {
    "set_attr_item": {
        "attribute": "HostName",
        "new_value": "welktxef-931856-rz-le0pts6-004",
        "path": "/redfish/v1/Systems/Self"
    }
}
...
ok: [welktxef-931856-rz-le0pts6-004] => {
    "response": {
        ...
        "cookies": {},
        "cookies_string": "",
        "date": "Wed, 22 Oct 2025 00:38:40 GMT",
        "elapsed": 3,
        "etag": "\"1761093520\"",
        "failed": false,
        "msg": "OK (unknown bytes)",
...
TASK [redfish/attributes : what is currently verified] **********************************************************************************************
ok: [welktxef-931856-rz-le0pts6-004] => {
    "msg": "Sending GET to /redfish/v1/Systems/Self and query the returned json for HostName. Value shall be welktxef-931856-rz-le0pts6-004"
}
...
PLAY RECAP ******************************************************************************************************************************************
welktxef-931856-rz-le0pts6-004 : ok=15   changed=0    unreachable=0    failed=0    skipped=5    rescued=0    ignored=0
...
```log
(ansible_2.10.15) [XXXXXX@welktxefnce-h-pe1util-vm01 vcp-fe-ib-automation]$ curl -gsk -u XXXXXX:XXXXXX -X GET https://[2607:f160:10:80b1:ce:40a:0:e003]/redfish/v1/Managers/Self/EthernetInterfaces/eth0 | jq .StaticNameServers
[
