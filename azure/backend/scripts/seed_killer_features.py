#!/usr/bin/env python3
"""
Seed Cosmos DB tables that power the 5 Killer Features end-to-end.
...
def to_ddb(value: Any) -> Any:
    """Convert Python values into Cosmos DB-safe types (floats → Decimal)."""
...
def main() -> int:
    ...
    ddb    = boto3.resource("cosmos_db", region_name=REGION)
