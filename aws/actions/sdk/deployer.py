...
Deploy actions to AgentCore Gateway
"""
...
class ApexActionDeployer:
    """
    Deploy Apex Actions to AgentCore Gateway
    ...
    def _add_gateway_target(
        ...
        try:
            self.lambda_client.add_permission(
                FunctionName=function_name,
                StatementId=f'AgentCoreGateway-{self.gateway_id}',
                Action='lambda:InvokeFunction',
                Principal='bedrock-agentcore.amazonaws.com',
                SourceArn=f'arn:aws:bedrock-agentcore:{self.region}:*:gateway/{self.gateway_id}'
            )
