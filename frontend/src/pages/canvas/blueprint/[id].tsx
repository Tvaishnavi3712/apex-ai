      ...
      {showDeployModal && (
        <div className="modal-overlay" onClick={() => setShowDeployModal(false)}>
          <div className="modal" style={{ padding: 28 }} onClick={(e) => e.stopPropagation()}>
            <h3 style={{ fontSize: 16, fontWeight: 700, color: '#0f172a', marginBottom: 8 }}>Deploy to Azure AI Document Intelligence</h3>
 ...
 *     documentSchema: { fields: { <name>: { type, description, required, ... } } } }
 *
 * The documentSchema.fields is a DICT (not array), keyed by field name. We
...
function _apiToBlueprintData(api: any): BlueprintData {
  ...
  // (flattened by the seeder from any of: documentSchema.fields / documentSchema.properties /
  ...
  const rawFields =
    ...
    ?? api?.documentSchema?.fields              // legacy BDA wrapper
  ...
  return {
    ...
    version:        api.version || api?.documentSchema?.version || 'v1.0',
    description:    api.description || api?.documentSchema?.description || '',
    industry_label: industryLabel,
    status_label:   status.charAt(0).toUpperCase() + status.slice(1),
    status_chip:    statusChipMap[status] || 'chip-gray',
    arn:            api.arn || '',
    document_class: api.document_type || api?.documentSchema?.documentClass || '',
...
const CBB_BLUEPRINT_DATA: Record<string, BlueprintData> = {
  'bp-cbb-order': {
    ...
    arn: 'azure-docintel/CBB/blueprint/order-mod-v2.1',
    fields: [
  ...
  'bp-cbb-qc': {
    ...
    status_label: 'Deployed',
    status_chip: 'chip-green',
    arn: 'azure-docintel/CBB/blueprint/qc-cert-v3.0',
    fields: [
  ...
  'bp-cbb-disrupt': {
    ...
    status_label: 'Deployed',
    status_chip: 'chip-green',
    arn: 'azure-docintel/CBB/blueprint/supplier-alert-v1.0',
    fields: [
...
const STP_BLUEPRINT_DATA: Record<string, BlueprintData> = {
  'bp-stp-hr-policy': {
    ...
    status_label: 'Deployed',
    status_chip: 'chip-green',
    arn: 'azure-docintel/STP/blueprint/hr-policy-v1',
    fields: [
  ...
  'bp-stp-procedure': {
    ...
    status_label: 'Deployed',
    status_chip: 'chip-green',
    arn: 'azure-docintel/STP/blueprint/procedure-v1',
    fields: [
  ...
  'bp-stp-work-order': {
    ...
    status_label: 'Deployed',
    status_chip: 'chip-green',
    arn: 'azure-docintel/STP/blueprint/work-order-v1',
    fields: [
  ...
  'bp-stp-work-package': {
    ...
    status_label: 'Deployed',
    status_chip: 'chip-green',
    arn: 'azure-docintel/STP/blueprint/work-package-v1',
    fields: [
  ...
  'bp-stp-incident': {
    ...
    status_label: 'Deployed',
    status_chip: 'chip-green',
    arn: 'azure-docintel/STP/blueprint/incident-v1',
    fields: [
  ...
  'bp-stp-sensor': {
    ...
    status_label: 'Deployed',
    status_chip: 'chip-green',
    arn: 'azure-docintel/STP/blueprint/sensor-v1',
    fields: [
...
const TELCO_BLUEPRINT_DATA: Record<string, BlueprintData> = {
  'bp-tel-robot': {
    ...
    status_label: 'Deployed',
    status_chip: 'chip-green',
    arn: 'azure-docintel/VZ/blueprint/robot-framework-v1',
    fields: [
  ...
  'bp-tel-redfish': {
    ...
    status_label: 'Deployed',
    status_chip: 'chip-green',
    arn: 'azure-docintel/VZ/blueprint/redfish-schema-v1',
    fields: [
  ...
  'bp-tel-runbook': {
    ...
    status_label: 'Deployed',
    status_chip: 'chip-green',
    arn: 'azure-docintel/VZ/blueprint/upgrade-runbook-v1',
    fields: [
  ...
  'bp-tel-kb': {
    ...
    status_label: 'Deployed',
    status_chip: 'chip-green',
    arn: 'azure-docintel/VZ/blueprint/known-issues-v1',
    fields: [
  ...
  'bp-tel-cert-rpt': {
    ...
    status_label: 'Deployed',
    status_chip: 'chip-green',
    arn: 'azure-docintel/VZ/blueprint/certification-report-v1',
    fields: [
...
const EPROD_BLUEPRINT_DATA: Record<string, BlueprintData> = {
  'bp-eprod-invoice': {
    ...
    status_label: 'Deployed',
    status_chip: 'chip-green',
    arn: 'azure-docintel/EPROD/blueprint/invoice-v1',
    fields: [
  ...
  'bp-eprod-po': {
    ...
    status_label: 'Deployed',
    status_chip: 'chip-green',
    arn: 'azure-docintel/EPROD/blueprint/purchase-order-v1',
    fields: [
  ...
  'bp-eprod-msa': {
    ...
    status_label: 'Deployed',
    status_chip: 'chip-green',
    arn: 'azure-docintel/EPROD/blueprint/msa-v1',
    fields: [
  ...
  'bp-eprod-quote': {
    ...
    status_label: 'Deployed',
    status_chip: 'chip-green',
    arn: 'azure-docintel/EPROD/blueprint/engineering-quote-v1',
    fields: [
  ...
  'bp-eprod-tariff': {
    ...
    status_label: 'Deployed',
    status_chip: 'chip-green',
    arn: 'azure-docintel/EPROD/blueprint/ferc-tariff-v1',
    fields: [
  ...
  'bp-eprod-jib': {
    ...
    status_label: 'Deployed',
    status_chip: 'chip-green',
    arn: 'azure-docintel/EPROD/blueprint/jib-statement-v1',
    fields: [
...
const DEFAULT_BLUEPRINT: BlueprintData = {
  ...
  version: '—',
  description: 'No blueprint matches this id, and the platform API is unreachable. Verify the id in the URL, or seed the blueprint into Cosmos DB via POST /api/v1/blueprints/seed?industry=<industry>.',
  industry_label: '',
  industry_key: '',
  document_class: '',
