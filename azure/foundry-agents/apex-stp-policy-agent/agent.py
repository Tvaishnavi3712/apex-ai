"""
Apex STP PolicyAgent — Foundry Agent Service runtime for STP Demo UC-1 (Policy & Procedure
...
def _resolve_models(model_overrides: Dict[str, Dict[str, str]] | None) -> tuple:
    """Resolve which AzureOpenAIModel ids to use for tool calls vs synthesis."""
