  ...
  return (
    <>
          ...
          <div className="card" style={{ padding: 28, marginBottom: 20 }}>
            ...
            <div style={{ background: '#fffbeb', border: '1px solid #fde68a', borderRadius: 12, padding: 14 }}>
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10 }}>
                ...
                <p style={{ fontSize: 13, color: '#92400e' }}>APEX will use <strong>Amazon Bedrock Data Automation</strong> to analyze your document and suggest field definitions automatically. You can review and edit them in the next step.</p>
              </div>
            </div>
          </div>
        ...
        <div style={{ maxWidth: 860 }}>
          <div className="card" style={{ padding: 28, marginBottom: 20 }}>
            ...
            <div style={{ background: '#eff6ff', border: '1px solid #bfdbfe', borderRadius: 12, padding: '12px 16px', marginBottom: 20, display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <p style={{ fontSize: 13, color: '#1e40af' }}>Bedrock Data Automation analyzed <strong>sample_invoice_acme.pdf</strong> and detected 12 fields with an average confidence of 94%.</p>
            </div>
      ...
      {step === 4 && (
        <div style={{ maxWidth: 720 }}>
          <div className="card" style={{ padding: 28, marginBottom: 20 }}>
            <h2 style={{ fontSize: 18, fontWeight: 700, color: '#0f172a', marginBottom: 4 }}>Deploy to Bedrock Data Automation</h2>
            <p style={{ fontSize: 14, color: '#64748b', marginBottom: 24 }}>Review your blueprint schema and deploy it to AWS Bedrock.</p>
            ...
            >
              ...
              Deploy to Amazon Bedrock Data Automation
            </button>
          </div>
      ...
      {showModal && (
        <div className="modal-overlay">
          <div className="modal" style={{ padding: 32, textAlign: 'center' }}>
            ...
            <p style={{ fontSize: 14, color: '#64748b', marginBottom: 16 }}>Your blueprint is now live in Amazon Bedrock Data Automation.</p>
            <div style={{ background: '#f8fafc', borderRadius: 12, padding: 14, marginBottom: 20, textAlign: 'left' }}>
              ...
              <div className="mono" style={{ fontSize: 11, color: '#374151', wordBreak: 'break-all' }}>arn:aws:bedrock:us-east-1:457795063704:blueprint/inv-bp-v2-20240420</div>
            </div>
