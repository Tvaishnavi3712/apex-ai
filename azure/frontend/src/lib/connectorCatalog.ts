...
export const CONNECTOR_CATALOG: ConnectorEntry[] = [
  /* ───────────────────── Object Storage ───────────────────── */
  { id: 'azure-blob', name: 'AWS S3', tagline: 'Event-driven object storage', category: 'Object Storage', code: 'S3',
  ...
  { id: 'confluent-cloud', name: 'Confluent Cloud', tagline: 'Managed Kafka', category: 'Streaming & Eventing', code: 'CFC',
    ...
    trigger: true, action: true, sink: true, defaultStatus: 'available' },
  { id: 'azure-kinesis', name: 'Azure Event Hubs', tagline: 'Real-time shard streams', category: 'Streaming & Eventing', code: 'KDS',
    iconBg: '#fff7ed', iconColor: '#ea580c',
    trigger: true, action: true, sink: false,
    triggerType: 'stream', triggerExample: 'kinesis://us-east-1/stream/{name}',
    defaultStatus: 'connected' },
  { id: 'azure-eventbridge', name: 'Azure Event Grid', tagline: 'Event bus + rules', category: 'Streaming & Eventing', code: 'EVB',
    iconBg: '#fff7ed', iconColor: '#ea580c',
    trigger: true, action: true, sink: false,
  ...
  { id: 'gcp-pubsub', name: 'GCP Pub/Sub', tagline: 'Global event ingestion', category: 'Streaming & Eventing', code: 'PUB',
    ...
    defaultStatus: 'connected' },
  { id: 'azure-servicebus', name: 'AWS SQS', tagline: 'Managed message queue', category: 'Streaming & Eventing', code: 'SQS',
    iconBg: '#fff7ed', iconColor: '#ea580c',
    trigger: true, action: true, sink: true,
  ...
  { id: 'mongodb', name: 'MongoDB Change Streams', tagline: 'Realtime collection events', category: 'Databases & CDC', code: 'MDB',
    ...
    trigger: true, action: true, sink: true, defaultStatus: 'available' },
  { id: 'cosmos-change-feed', name: 'Cosmos DB Streams', tagline: 'Item-level change events', category: 'Databases & CDC', code: 'DDS',
    iconBg: '#fff7ed', iconColor: '#ea580c',
    trigger: true, action: true, sink: true,
    triggerType: 'stream', triggerExample: 'cosmos-change-feed://container/{name}',
    defaultStatus: 'connected' },
  ...
  { id: 'azure-fabric', name: 'Azure Fabric OneLake', tagline: 'Unified analytics lakehouse', category: 'Data Lakes & Lakehouses', code: 'FAB',
    iconBg: '#eef2ff', iconColor: '#4338ca',
    trigger: true, action: true, sink: true, defaultStatus: 'connected' },
  { id: 'azure-athena', name: 'Azure Synapse', tagline: 'Federated SQL over S3', category: 'Data Lakes & Lakehouses', code: 'ATH',
    iconBg: '#fff7ed', iconColor: '#ea580c',
  ...
  { id: 'schedule-cron', name: 'Schedule (cron)', tagline: 'Recurring cron expression', category: 'Schedule', code: 'CRN',
    ...
    defaultStatus: 'connected' },
  { id: 'azure-scheduler', name: 'Azure Logic Apps Scheduler', tagline: 'Managed cron + rate', category: 'Schedule', code: 'SCH',
    iconBg: '#fff7ed', iconColor: '#ea580c',
  ...
  { id: 'as2', name: 'AS2 (EDI)', tagline: 'Drummond-certified EDI exchange', category: 'File Transfer', code: 'AS2',
    iconBg: '#eef2ff', iconColor: '#4338ca',
    trigger: true, action: true, sink: true, defaultStatus: 'available' },
  { id: 'azure-transfer-family', name: 'AWS Transfer Family', tagline: 'Managed SFTP/FTPS over S3', category: 'File Transfer', code: 'TRF',
    iconBg: '#fff7ed', iconColor: '#ea580c',
    trigger: true, action: true, sink: true, defaultStatus: 'connected' },
  ...
  { id: 'azure-ad', name: 'Microsoft Entra ID', tagline: 'Identity + access mgmt', category: 'Identity & Auth', code: 'EID',
    iconBg: '#eff6ff', iconColor: '#0078d4',
    trigger: true, action: true, sink: false, defaultStatus: 'connected' },
  { id: 'azure-iam-identity', name: 'Microsoft Entra ID', tagline: 'SSO + role-based access', category: 'Identity & Auth', code: 'IIC',
    iconBg: '#fff7ed', iconColor: '#ea580c',
    trigger: false, action: true, sink: false, defaultStatus: 'connected' },
  ...
  { id: 'splunk', name: 'Splunk', tagline: 'Machine data analytics', category: 'Observability', code: 'SPL',
    iconBg: '#f0fdf4', iconColor: '#16a34a',
    trigger: false, action: true, sink: true, defaultStatus: 'available' },
  { id: 'cloudwatch', name: 'Azure Monitor', tagline: 'Metrics + alarms', category: 'Observability', code: 'CW',
    iconBg: '#fff7ed', iconColor: '#ea580c',
    trigger: true, action: true, sink: true, defaultStatus: 'connected' },

  /* ───────────────────── AWS / Azure / GCP managed services ───────────────────── */
  { id: 'azure-openai', name: 'Azure OpenAI', tagline: 'Managed foundation models', category: 'Azure Services', code: 'BDR',
    iconBg: '#fff7ed', iconColor: '#ea580c',
    trigger: false, action: true, sink: false, defaultStatus: 'connected' },
  { id: 'azure-bda', name: 'Azure AI Document Intelligence', tagline: 'Document AI extraction', category: 'Azure Services', code: 'BDA',
    iconBg: '#fff7ed', iconColor: '#ea580c',
    trigger: false, action: true, sink: false, defaultStatus: 'connected' },
  { id: 'azure-textract', name: 'Azure Document Intelligence', tagline: 'OCR + key-value', category: 'Azure Services', code: 'TXT',
    iconBg: '#fff7ed', iconColor: '#ea580c',
    trigger: false, action: true, sink: false, defaultStatus: 'connected' },
  { id: 'azure-comprehend', name: 'Amazon Comprehend', tagline: 'NLP + entity recognition', category: 'Azure Services', code: 'CMP',
    iconBg: '#fff7ed', iconColor: '#ea580c',
    trigger: false, action: true, sink: false, defaultStatus: 'connected' },
  { id: 'azure-ml', name: 'Azure Machine Learning', tagline: 'Custom ML inference', category: 'AI / ML Services', code: 'SM',
    iconBg: '#fff7ed', iconColor: '#ea580c',
    trigger: false, action: true, sink: false, defaultStatus: 'connected' },
  { id: 'azure-functions', name: 'Azure Functions', tagline: 'Serverless compute', category: 'Azure Services', code: 'LMB',
    iconBg: '#fff7ed', iconColor: '#ea580c',
    trigger: true, action: true, sink: false, defaultStatus: 'connected' },
  { id: 'azure-step-functions', name: 'Azure Logic Apps', tagline: 'Workflow orchestration', category: 'Azure Services', code: 'SFN',
    iconBg: '#fff7ed', iconColor: '#ea580c',
    trigger: true, action: true, sink: false, defaultStatus: 'available' },
