# ZT BMC 1.13 BIOS v1.01
# HPE e910t server
# 02/05/25 James Patchett - MTCE Lab VCPfe
...
| Property       | Value                                 |
+----------------+---------------------------------------+
| created_at     | 2025-02-05T23:57:28.169798+00:00      |
| isystem_uuid   | 9e33cf99-272c-491a-b993-2742afca5cf4  |
| oam_end_ip     | 2607:f160:10:8803:ffff:ffff:ffff:fffe |
| oam_gateway_ip | 2607:f160:10:8803:ce:23::             |
| oam_ip         | 2607:f160:10:8803:ce:40a:0:f405       |
| oam_start_ip   | 2607:f160:10:8803::1                  |
| oam_subnet     | 2607:f160:10:8803::/64                |
| updated_at     | None                                  |
| uuid           | 051fedf9-8a99-45e7-a83c-644aafc5e7a0  |
+----------------+---------------------------------------+
...
```log
Every 60.0s: ipmitool sensor| grep -e CPU -e FAN -e Watts                                                       controller-0: Thu Feb  6 01:57:32 2025
...
SYS_FAN_2B       | 3534.000   | RPM        | ok    | na        | 1026.000  | na        | na        | 28500.000 | na
CPU0_Power       | 70.000     | Watts      | ok    | na        | na        | na        | na        | na        | na
MB_HSC_PEAK_PIN  | 348.540    | Watts      | ok    | na        | na        | na        | na        | na        | na
MB_HSC_PIN       | 131.880    | Watts      | ok    | na        | na        | na        | na        | na        | na
MB_HSC_PIN_AVG   | 146.010    | Watts      | ok    | na        | na        | na        | na        | na        | na
PSU_1_POWER_IN   | 165.200    | Watts      | ok    | na        | na        | na        | na        | na        | na
PSU_1_POWER_OUT  | 153.400    | Watts      | ok    | na        | na        | na        | na        | na        | na
...
CPU_0_DIMM_A0    | 43.000     | degrees C  | ok    | na        | 6.000     | na        | na        | 82.000    | na
CPU_0_DIMM_B0    | 42.000     | degrees C  | ok    | na        | 6.000     | na        | na        | 82.000    | na
CPU_0_DIMM_C0    | 40.000     | degrees C  | ok    | na        | 6.000     | na        | na        | 82.000    | na
CPU_0_DIMM_D0    | 41.000     | degrees C  | ok    | na        | 6.000     | na        | na        | 82.000    | na
CPU_0_DIMM_E0    | 43.000     | degrees C  | ok    | na        | 6.000     | na        | na        | 82.000    | na
CPU_0_DIMM_F0    | 41.000     | degrees C  | ok    | na        | 6.000     | na        | na        | 82.000    | na
CPU_0_DIMM_G0    | 39.000     | degrees C  | ok    | na        | 6.000     | na        | na        | 82.000    | na
CPU_0_DIMM_H0    | 38.000     | degrees C  | ok    | na        | 6.000     | na        | na        | 82.000    | na
CPU_0_DTS_TEMP   | -39.000    | degrees C  | ok    | na        | na        | na        | na        | na        | na
CPU_0_MARGIN     | 31.000     | degrees C  | ok    | na        | na        | na        | na        | na        | na
CPU_0_TEMP       | 52.000     | degrees C  | ok    | na        | na        | na        | 89.000    | 91.000    | na
BMC_CPU          | 19.000     | percent    | ok    | na        | na        | na        | na        | na        | na
BMC_CPU_Kernel   | 9.000      | percent    | ok    | na        | na        | na        | na        | na        | na
BMC_CPU_User     | 9.000      | percent    | ok    | na        | na        | na        | na        | na        | na
CPU_CUPS         | 5.096      | percent    | ok    | na        | na        | na        | na        | na        | na
...
```log
root@controller-0:/home/XXXXXX/ptat# ./ptat -id -ct 1 -b 0

Command: ./ptat -id -ct 1 -b 0
...
BIOS Version:                        American Megatrends International, LLC., 1.01, 12/07/2023
Processor(s):                        1 Processor(s) Installed.
DIMM(s):                             8 DIMM(s) Installed.
Total System Memory:                 255109 MB
Available System Memory:             181683 MB
...
[02/06/25 01:33:15 UTC] PTAT started.

Press <Ctrl-C> to stop.


CPU_0: [IDLE] CFreq=1300, UFreq=1600, PState=1, Util=1.87, IPC=2.21, Temp=49, DTS=42, Power=64.1, Volt=0.676, UVolt=0.740
MEM_0: [IDLE] Power=14.48, Temp=38, Read=0.0, Write=0.0
MEM_0: [TESTCFG] TestSel=1 (Read), CoreMask=0x1, ThreadMask=0x1, PwrLevel=100, Turbo=0
MEM_0: [RUNNING] Power=14.45, Temp=38, Read=748.4, Write=295.2
CPU_0: , CoreMask=0xFFFFFFFFFFFFFFFF, ThreadMask=0xFFFFFFFFFFFFFFFF, PwrLevel=TDP, Turbo=0
CPU_0: [RUNNING] CFreq=1300, UFreq=1600, PState=1, Util=100.00, IPC=5.99, Temp=56, DTS=35, Power=126.9, Volt=0.670, UVolt=0.738
63.0, Volt=0.753
