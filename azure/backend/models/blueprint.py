...
Represents Azure AI Document Intelligence blueprints for document extraction
"""
...
class Blueprint(BlueprintBase):
    ...
    # BDA references
    docintel_blueprint_id: Optional[str] = Field(None, description="BDA Blueprint ARN")
