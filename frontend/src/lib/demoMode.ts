...
export const INDUSTRY_KEYS = [
  ...
  // and journal-entry distribution. Runs entirely on Azure (S3 + Lambda +
  // Step Functions + Azure OpenAI + Cosmos DB + SES + SNS + QuickSight). Customer
  ...
  // automated, all inside your Azure subscription."
  'boler',
] as const;
