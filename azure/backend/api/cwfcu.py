...
Mirrors the EPROD pattern in `eprod_cycle.py`. Azure ML / Foundry Agent Service are
...
# ─────────────────────────────────────────────────────────────────────
# Individual signal endpoints (deterministic — no Azure ML)
# ─────────────────────────────────────────────────────────────────────
...
async def signal_delinquency_early_warning() -> Dict[str, Any]:
    """Deterministic delinquency early-warning signal (no Azure ML)."""
    return {
