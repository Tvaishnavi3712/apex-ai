...
def inventory_update(
    ...
    try:
        ...
        inventory_table = dynamodb.Table(os.environ.get('INVENTORY_TABLE', 'apex-retail-inventory'))
        audit_table = dynamodb.Table(os.environ.get('INVENTORY_AUDIT_TABLE', 'apex-inventory-audit'))
